def transformacion(conn=None, creds=None):
    ...
    from Data.feature_engineering.cdc_l3 import get_cdc_date
    from Data.feature_engineering.transformar_datos import transformar_datos
    import sys
    import pandas as pd
    import os
    os.system('clear')
    ...
    cdc_date = get_cdc_date(f"cdz_to_ddz {ticker}",creds=creds,conn=conn)
